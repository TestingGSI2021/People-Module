...
//	static WebDriver driver = Set_Webdriver.DRIVER.Get_Driver();
	...
	public  void Wait_Until_Element_Is_Clickable(int time_To_Wait, By locator) {
		new WebDriverWait(driver, time_To_Wait).until(ExpectedConditions.elementToBeClickable(locator));
	}
